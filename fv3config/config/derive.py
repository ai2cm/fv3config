...
def get_n_processes(config_dict):
    n_tiles = config_dict['namelist']['fv_core_nml'].get('ntiles', NAMELIST_DEFAULTS['ntiles'])
    layout = config_dict['namelist']['fv_core_nml'].get('layout', NAMELIST_DEFAULTS['layout'])
